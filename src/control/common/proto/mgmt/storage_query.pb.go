...
func (m *DevStateReq) GetDevTraddr() string {
	if m != nil {
		return m.DevTraddr
	}
	return ""
...
type DevStateResp struct {
	...
	DevTraddr            string   `protobuf:"bytes,4,opt,name=dev_traddr,json=devTraddr,proto3" json:"dev_traddr,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *DevStateResp) GetDevTraddr() string {
	if m != nil {
		return m.DevTraddr
	}
	return ""
...
var fileDescriptor_d87a8d20722a9416 = []byte{
	...
	,
}
